...
public final class Tuples3 {
    public static final <A, B> Tuples<A, B> to(A a, B b) {
    ...
    public static final <T> List<T> toList(Tuples2<? extends T, ? extends T, ? extends T> toList) {
        Intrinsics.checkParameterIsNotNull(toList, "$this$toList");

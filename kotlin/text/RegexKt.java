...
public final class RegexKt {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Ranges5 range(java.util.regex.MatchResult $this$range) {
        return RangesKt.until($this$range.start(), $this$range.end());
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Ranges5 range(java.util.regex.MatchResult $this$range, int groupIndex) {

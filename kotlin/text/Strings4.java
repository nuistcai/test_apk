...
/* renamed from: kotlin.text.StringsKt__StringsKt$rangesDelimitedBy$4 */
/* loaded from: classes.dex */
final class Strings4 extends Lambda implements Function2<CharSequence, Integer, Tuples<? extends Integer, ? extends Integer>> {
    final /* synthetic */ List $delimitersList;
    final /* synthetic */ boolean $ignoreCase;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    Strings4(List list, boolean z) {
        super(2);
        delimitersList = list;
        ignoreCase = z;
    }

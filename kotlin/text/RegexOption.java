...
jadx.core.utils.exceptions.JadxRuntimeException: Init of enum field 'MULTILINE' uses external variables
...
public final class RegexOption implements FlagEnum {
    ...
    static {
        ...
        int i2 = 0;
        RegexOption regexOption2 = new RegexOption("MULTILINE", 1, 8, i2, i, defaultConstructorMarker);
        MULTILINE = regexOption2;
        int i3 = 2;
        DefaultConstructorMarker defaultConstructorMarker2 = null;
        int i4 = 0;
        RegexOption regexOption3 = new RegexOption("LITERAL", 2, 16, i4, i3, defaultConstructorMarker2);
        LITERAL = regexOption3;
        RegexOption regexOption4 = new RegexOption("UNIX_LINES", 3, 1, i2, i, defaultConstructorMarker);
        UNIX_LINES = regexOption4;
        RegexOption regexOption5 = new RegexOption("COMMENTS", 4, 4, i4, i3, defaultConstructorMarker2);
        COMMENTS = regexOption5;
        RegexOption regexOption6 = new RegexOption("DOT_MATCHES_ALL", 5, 32, i2, i, defaultConstructorMarker);
        DOT_MATCHES_ALL = regexOption6;
        RegexOption regexOption7 = new RegexOption("CANON_EQ", 6, 128, i4, i3, defaultConstructorMarker2);

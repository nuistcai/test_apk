...
public final /* data */ class MatchGroup {
    private final Ranges5 range;
    private final String value;

    public static /* synthetic */ MatchGroup copy$default(MatchGroup matchGroup, String str, Ranges5 ranges5, int i, Object obj) {
        if ((i & 1) != 0) {
            str = matchGroup.value;
        }
        if ((i & 2) != 0) {
            ranges5 = matchGroup.range;
        }
        return matchGroup.copy(str, ranges5);
    }
    ...
    public final Ranges5 getRange() {
        return this.range;
    }

    public final MatchGroup copy(String value, Ranges5 range) {
    ...
    public int hashCode() {
        ...
        Ranges5 ranges5 = this.range;
        return iHashCode + (ranges5 != null ? ranges5.hashCode() : 0);
    }
    ...
    public MatchGroup(String value, Ranges5 range) {
        Intrinsics.checkParameterIsNotNull(value, "value");
        Intrinsics.checkParameterIsNotNull(range, "range");
        this.value = value;
        this.range = range;

...
public final class Duration2 {
    ...
    public static final double toDuration(double $this$toDuration, TimeUnit unit) {
        Intrinsics.checkParameterIsNotNull(unit, "unit");
        return Duration.m933constructorimpl(DurationUnitKt.convertDurationUnit($this$toDuration, unit, TimeUnit.NANOSECONDS));
    }
    ...
    private static final double m978timesmvk6XK0(int $this$times, double duration) {
        return Duration.m960timesimpl(duration, $this$times);
    }

    /* renamed from: times-kIfJnKk, reason: not valid java name */
    private static final double m977timeskIfJnKk(double $this$times, double duration) {
        return Duration.m959timesimpl(duration, $this$times);
    }
}
...
public final /* data */ class TimedValue<T> {
    ...
    public static /* synthetic */ TimedValue m981copyRFiDyg4$default(TimedValue timedValue, Object obj, double d, int i, Object obj2) {
        if ((i & 1) != 0) {
        ...
        return timedValue.m982copyRFiDyg4(obj, d);
    }
    ...
    public final TimedValue<T> m982copyRFiDyg4(T value, double duration) {
    ...
    public String toString() {
        return "TimedValue(value=" + this.value + ", duration=" + Duration.m971toStringimpl(this.duration) + ")";
    }

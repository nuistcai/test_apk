...
/* renamed from: kotlin.time.AbstractDoubleClock, reason: use source file name */
...
public abstract class Clocks implements Clock {
    ...
    /* renamed from: kotlin.time.AbstractDoubleClock$DoubleClockMark */
    private static final class DoubleClockMark extends Clock4 {
        private final Clocks clock;
        private final double offset;
        private final double startedAt;

        private DoubleClockMark(double startedAt, Clocks clock, double offset) {
            this.startedAt = startedAt;
            this.clock = clock;
            this.offset = offset;
        }

        public /* synthetic */ DoubleClockMark(double startedAt, Clocks clock, double offset, DefaultConstructorMarker $constructor_marker) {
        ...
        public Clock4 mo929plusLRDsOJo(double duration) {
            return new DoubleClockMark(this.startedAt, this.clock, Duration.m957plusLRDsOJo(this.offset, duration), null);
        }
    }

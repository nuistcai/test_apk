...
/* renamed from: kotlin.time.AdjustedClockMark, reason: use source file name */
/* loaded from: classes.dex */
final class Clock2 extends Clock4 {
    private final double adjustment;
    private final Clock4 mark;

    private Clock2(Clock4 mark, double adjustment) {
        this.mark = mark;
        this.adjustment = adjustment;
    }

    public /* synthetic */ Clock2(Clock4 mark, double adjustment, DefaultConstructorMarker $constructor_marker) {
    ...
    public final Clock4 getMark() {
        return this.mark;
    }

    @Override // kotlin.time.Clock4
    public double elapsedNow() {
        return Duration.m956minusLRDsOJo(this.mark.elapsedNow(), this.adjustment);
    }

    @Override // kotlin.time.Clock4
    /* renamed from: plus-LRDsOJo */
    public Clock4 mo929plusLRDsOJo(double duration) {
        return new Clock2(this.mark, Duration.m957plusLRDsOJo(this.adjustment, duration), null);
    }
}
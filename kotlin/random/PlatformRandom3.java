...
public final class PlatformRandom3 extends PlatformRandom2 {
    private final PlatformRandom4 implStorage = new ThreadLocal<java.util.Random>() { // from class: kotlin.random.FallbackThreadLocalRandom$implStorage$1

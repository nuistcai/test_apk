...
/* renamed from: kotlin.collections.MapWithDefaultImpl, reason: use source file name */
/* loaded from: classes.dex */
final class MapWithDefault2<K, V> implements MapWithDefault<K, V> {
    ...
    public MapWithDefault2(Map<K, ? extends V> map, Function1<? super K, ? extends V> function1) {

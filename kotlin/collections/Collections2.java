...
/* renamed from: kotlin.collections.CollectionsKt__CollectionsKt, reason: use source file name */
...
public class Collections2 extends CollectionsJVM {
    ...
    public static final Ranges5 getIndices(Collection<?> indices) {
        Intrinsics.checkParameterIsNotNull(indices, "$this$indices");
        return new Ranges5(0, indices.size() - 1);
    }

...
public final class _UArraysJvm2 extends AbstractList<UInt> implements RandomAccess {
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof UInt) {
            return m378containsWZ4Q5Ns(((UInt) obj).getData());
        }
        return false;
    }
    ...
    public final /* bridge */ int indexOf(Object obj) {
        if (obj instanceof UInt) {
            return m379indexOfWZ4Q5Ns(((UInt) obj).getData());
        }
        return -1;
    }
    ...
    public final /* bridge */ int lastIndexOf(Object obj) {
        if (obj instanceof UInt) {
            return m380lastIndexOfWZ4Q5Ns(((UInt) obj).getData());
        }
        return -1;
    }
    ...
    public int getSize() {
        return UIntArray.m148getSizeimpl(this.$this_asList);
    }

    @Override // kotlin.collections.AbstractCollection, java.util.Collection
    public boolean isEmpty() {
        return UIntArray.m150isEmptyimpl(this.$this_asList);
    }

    /* renamed from: contains-WZ4Q5Ns, reason: not valid java name */
    public boolean m378containsWZ4Q5Ns(int element) {
        return UIntArray.m143containsWZ4Q5Ns(this.$this_asList, element);
    }

    @Override // kotlin.collections.AbstractList, java.util.List
    public UInt get(int index) {
        return UInt.m90boximpl(UIntArray.m147getimpl(this.$this_asList, index));
    }

    /* renamed from: indexOf-WZ4Q5Ns, reason: not valid java name */
    public int m379indexOfWZ4Q5Ns(int element) {
        return ArraysKt.indexOf(this.$this_asList, element);
    }

    /* renamed from: lastIndexOf-WZ4Q5Ns, reason: not valid java name */
    public int m380lastIndexOfWZ4Q5Ns(int element) {

...
public final class _UArraysJvm4 extends AbstractList<UByte> implements RandomAccess {
    ...
    public final /* bridge */ int indexOf(Object obj) {
        if (obj instanceof UByte) {
            return m385indexOf7apg3OU(((UByte) obj).getData());
        }
        return -1;
    }
    ...
    public final /* bridge */ int lastIndexOf(Object obj) {
        if (obj instanceof UByte) {
            return m386lastIndexOf7apg3OU(((UByte) obj).getData());
        }
        return -1;
    }
    ...
    public int getSize() {
        return UByteArray.m79getSizeimpl(this.$this_asList);
    }

    @Override // kotlin.collections.AbstractCollection, java.util.Collection
    public boolean isEmpty() {
        return UByteArray.m81isEmptyimpl(this.$this_asList);
    }

    /* renamed from: contains-7apg3OU, reason: not valid java name */
    public boolean m384contains7apg3OU(byte element) {
        return UByteArray.m74contains7apg3OU(this.$this_asList, element);
    }

    @Override // kotlin.collections.AbstractList, java.util.List
    public UByte get(int index) {
        return UByte.m23boximpl(UByteArray.m78getimpl(this.$this_asList, index));
    }

    /* renamed from: indexOf-7apg3OU, reason: not valid java name */
    public int m385indexOf7apg3OU(byte element) {
        return ArraysKt.indexOf(this.$this_asList, element);
    }

    /* renamed from: lastIndexOf-7apg3OU, reason: not valid java name */
    public int m386lastIndexOf7apg3OU(byte element) {

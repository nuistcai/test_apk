...
public final class UnsignedUtils {
    ...
    public static final int m322uintDivideJ1ME1BU(int v1, int v2) {
        return UInt.m96constructorimpl((int) ((v1 & 4294967295L) / (4294967295L & v2)));
    }

    /* renamed from: uintRemainder-J1ME1BU, reason: not valid java name */
    public static final int m323uintRemainderJ1ME1BU(int v1, int v2) {
        return UInt.m96constructorimpl((int) ((v1 & 4294967295L) % (4294967295L & v2)));
    }

    /* renamed from: ulongDivide-eb3DHEI, reason: not valid java name */
    public static final long m324ulongDivideeb3DHEI(long v1, long v2) {
        if (v2 < 0) {
            return ULong.m165constructorimpl(ulongCompare(v1, v2) >= 0 ? 1L : 0L);
        }
        if (v1 >= 0) {
            return ULong.m165constructorimpl(v1 / v2);
        }
        long quotient = ((v1 >>> 1) / v2) << 1;
        long rem = v1 - (quotient * v2);
        return ULong.m165constructorimpl((ulongCompare(ULong.m165constructorimpl(rem), ULong.m165constructorimpl(v2)) < 0 ? 0 : 1) + quotient);
    }

    /* renamed from: ulongRemainder-eb3DHEI, reason: not valid java name */
    public static final long m325ulongRemaindereb3DHEI(long v1, long v2) {
        long j = 0;
        if (v2 < 0) {
        ...
        long quotient = ((v1 >>> 1) / v2) << 1;
        long rem = v1 - (quotient * v2);
        if (ulongCompare(ULong.m165constructorimpl(rem), ULong.m165constructorimpl(v2)) >= 0) {
            j = v2;
        }
        return ULong.m165constructorimpl(rem - j);
    }
    ...
    public static final int doubleToUInt(double v) {
        ...
        if (v <= d) {
            return UInt.m96constructorimpl((int) v);
        }
        Double.isNaN(d);
        return UInt.m96constructorimpl(UInt.m96constructorimpl((int) (v - d)) + UInt.m96constructorimpl(IntCompanionObject.MAX_VALUE));
    }
    ...
    public static final long doubleToULong(double v) {
        ...
        return v < ((double) LongCompanionObject.MAX_VALUE) ? ULong.m165constructorimpl((long) v) : ULong.m165constructorimpl(ULong.m165constructorimpl((long) (v - 9.223372036854776E18d)) - Long.MIN_VALUE);
    }

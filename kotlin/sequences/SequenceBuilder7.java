...
public class SequenceBuilder7 {
    ...
    public static final <T> Sequence<T> sequence(final Function2<? super SequenceBuilder6<? super T>, ? super Continuation<? super Unit>, ? extends Object> block) {
    ...
    private static final <T> Sequence<T> buildSequence(final Function2<? super SequenceBuilder6<? super T>, ? super Continuation<? super Unit>, ? extends Object> function2) {
    ...
    public static final <T> Iterator<T> iterator(Function2<? super SequenceBuilder6<? super T>, ? super Continuation<? super Unit>, ? extends Object> block) {
        Intrinsics.checkParameterIsNotNull(block, "block");
        SequenceBuilder5 iterator = new SequenceBuilder5();
    ...
    private static final <T> Iterator<T> buildIterator(Function2<? super SequenceBuilder6<? super T>, ? super Continuation<? super Unit>, ? extends Object> function2) {
        return SequencesKt.iterator(function2);
    }
}
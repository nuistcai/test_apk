...
final class SequenceBuilder5<T> extends SequenceBuilder6<T> implements Iterator<T>, Continuation<Unit>, KMarkers {
    ...
    public boolean hasNext() throws Throwable {
        while (true) {
            ...
            step.resumeWith(Result.m11constructorimpl(unit));
        }
    }
    ...
    @Override // kotlin.sequences.SequenceBuilder6
    ...
    public CoroutineContext get$context() {
        return CoroutineContextImpl3.INSTANCE;
    }
}
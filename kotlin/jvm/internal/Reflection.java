...
public class Reflection {
    ...
    public static KProperty6 property0(PropertyReference0 p) {
        return factory.property0(p);
    }

    public static KProperty3 mutableProperty0(MutablePropertyReference0 p) {
        return factory.mutableProperty0(p);
    }

    public static KProperty7 property1(PropertyReference1 p) {
        return factory.property1(p);
    }

    public static KProperty4 mutableProperty1(MutablePropertyReference1 p) {
        return factory.mutableProperty1(p);
    }

    public static KProperty8 property2(PropertyReference2 p) {
        return factory.property2(p);
    }

    public static KProperty5 mutableProperty2(MutablePropertyReference2 p) {

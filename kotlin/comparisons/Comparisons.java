...
/* renamed from: kotlin.comparisons.ComparisonsKt__ComparisonsKt, reason: use source file name */
...
public class Comparisons {
    ...
    public static final <T> Comparator<T> compareBy(final Function1<? super T, ? extends Comparable<?>>... selectors) {
        ...
        return new Comparator<T>() { // from class: kotlin.comparisons.ComparisonsKt__ComparisonsKt.compareBy.1
            ...
            public final int compare(T t, T t2) {
                return Comparisons.compareValuesByImpl$ComparisonsKt__ComparisonsKt(t, t2, selectors);
            }
        };
    }
    ...
    public static final class C00471<T> implements Comparator<T> {
        final /* synthetic */ Function1 $selector;

        public C00471(Function1 function1) {
            this.$selector = function1;
        }
    ...
    public static final <T extends Comparable<? super T>> Comparator<T> naturalOrder() {
        Comparisons2 comparisons2 = Comparisons2.INSTANCE;
    ...
    public static final <T extends Comparable<? super T>> Comparator<T> reverseOrder() {
        Comparisons3 comparisons3 = Comparisons3.INSTANCE;
        if (comparisons3 != null) {
            return comparisons3;
        }
        throw new TypeCastException("null cannot be cast to non-null type kotlin.Comparator<T> /* = java.util.Comparator<T> */");
    }
    ...
    public static final <T> Comparator<T> reversed(Comparator<T> reversed) {
        ...
        if (reversed instanceof Comparisons4) {
            return ((Comparisons4) reversed).getComparator();
        }
        if (Intrinsics.areEqual(reversed, Comparisons2.INSTANCE)) {
            Comparisons3 comparisons3 = Comparisons3.INSTANCE;
            if (comparisons3 != null) {
                return comparisons3;
            }
        ...
        if (!Intrinsics.areEqual(reversed, Comparisons3.INSTANCE)) {
            return new Comparisons4(reversed);
        }
        Comparisons2 comparisons2 = Comparisons2.INSTANCE;
        if (comparisons2 != null) {
            return comparisons2;

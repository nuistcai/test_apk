...
public final class FileTreeWalk implements Sequence<File> {
    ...
    private FileTreeWalk(File start, FileTreeWalk2 direction, Function1<? super File, Boolean> function1, Function1<? super File, Unit> function12, Function2<? super File, ? super IOException, Unit> function2, int maxDepth) {
        this.start = start;
    ...
    /* synthetic */ FileTreeWalk(File file, FileTreeWalk2 fileTreeWalk2, Function1 function1, Function1 function12, Function2 function2, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(file, (i2 & 2) != 0 ? FileTreeWalk2.TOP_DOWN : fileTreeWalk2, function1, function12, function2, (i2 & 32) != 0 ? IntCompanionObject.MAX_VALUE : i);
    }
    ...
    public /* synthetic */ FileTreeWalk(File file, FileTreeWalk2 fileTreeWalk2, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(file, (i & 2) != 0 ? FileTreeWalk2.TOP_DOWN : fileTreeWalk2);
    }

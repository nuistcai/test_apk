...
class Utils2 extends FileTreeWalk3 {
    ...
    public static final File copyTo(File copyTo, File target, boolean overwrite, int bufferSize) throws Exceptions6 {
    ...
    public static final boolean copyRecursively(File copyRecursively, File target, boolean overwrite, final Function2<? super File, ? super IOException, ? extends Utils3> onError) {
        boolean stillExists;
        Intrinsics.checkParameterIsNotNull(copyRecursively, "$this$copyRecursively");
        Intrinsics.checkParameterIsNotNull(target, "target");
        Intrinsics.checkParameterIsNotNull(onError, "onError");
        if (!copyRecursively.exists()) {
            return onError.invoke(copyRecursively, new Exceptions7(copyRecursively, null, "The source file doesn't exist.", 2, null)) != Utils3.TERMINATE;
        }
        try {
            Iterator<File> it = FilesKt.walkTopDown(copyRecursively).onFail(new Function2<File, IOException, Unit>() { // from class: kotlin.io.FilesKt__UtilsKt.copyRecursively.2
                ...
                @Override // kotlin.jvm.functions.Function2
                public /* bridge */ /* synthetic */ Unit invoke(File file, IOException iOException) throws Utils4 {
                    invoke2(file, iOException);
                    return Unit.INSTANCE;
                }

                /* renamed from: invoke, reason: avoid collision after fix types in other method */
                public final void invoke2(File f, IOException e) throws Utils4 {
                    Intrinsics.checkParameterIsNotNull(f, "f");
                    Intrinsics.checkParameterIsNotNull(e, "e");
                    if (((Utils3) onError.invoke(f, e)) == Utils3.TERMINATE) {
                        throw new Utils4(f);
                    }
                }
            }).iterator();
            while (it.hasNext()) {
                File src = it.next();
                if (!src.exists()) {
                    if (onError.invoke(src, new Exceptions7(src, null, "The source file doesn't exist.", 2, null)) == Utils3.TERMINATE) {
                        return false;
                    }
                } else {
                    ...
                    if (dstFile.exists() && (!src.isDirectory() || !dstFile.isDirectory())) {
                        ...
                        if (stillExists) {
                            if (onError.invoke(dstFile, new Exceptions5(src, dstFile, "The destination file already exists.")) == Utils3.TERMINATE) {
                                return false;
                            }
                        }
                    }
                    ...
                    if (stillExists2) {
                        dstFile.mkdirs();
                    } else if (FilesKt.copyTo$default(src, dstFile, overwrite, 0, 4, null).length() != src.length() && onError.invoke(src, new IOException("Source file wasn't copied completely, length of destination file differs.")) == Utils3.TERMINATE) {
                        return false;
                    }
                }
            }

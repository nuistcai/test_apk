...
public final /* data */ class Tuples2<A, B, C> implements Serializable {
    private final A first;
    private final B second;
    private final C third;

    /* JADX WARN: Multi-variable type inference failed */
    public static /* synthetic */ Tuples2 copy$default(Tuples2 tuples2, Object obj, Object obj2, Object obj3, int i, Object obj4) {
        if ((i & 1) != 0) {
            obj = tuples2.first;
        }
        if ((i & 2) != 0) {
        ...
        return tuples2.copy(obj, obj2, obj3);
    }
    ...
    public final Tuples2<A, B, C> copy(A first, B second, C third) {
        return new Tuples2<>(first, second, third);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.first, tuples2.first) && Intrinsics.areEqual(this.second, tuples2.second) && Intrinsics.areEqual(this.third, tuples2.third);
    }

...
final class Ranges2 implements Ranges3<Double> {
    private final double _endInclusive;
    private final double _start;

    public Ranges2(double start, double endInclusive) {
        this._start = start;
    ...
    public boolean equals(Object other) {
        return (other instanceof Ranges2) && ((isEmpty() && ((Ranges2) other).isEmpty()) || (this._start == ((Ranges2) other)._start && this._endInclusive == ((Ranges2) other)._endInclusive));
    }

...
public final class Ranges5 extends Progressions2 implements Range<Integer> {

    /* renamed from: Companion, reason: from kotlin metadata */
    public static final Companion INSTANCE = new Companion(null);
    private static final Ranges5 EMPTY = new Ranges5(1, 0);

    public Ranges5(int start, int endInclusive) {
    ...
    @Override // kotlin.ranges.Progressions2, kotlin.ranges.Range
    ...
    public boolean equals(Object other) {
        return (other instanceof Ranges5) && ((isEmpty() && ((Ranges5) other).isEmpty()) || (getFirst() == ((Ranges5) other).getFirst() && getLast() == ((Ranges5) other).getLast()));
    }
    ...
    public static final class Companion {
        ...
        public final Ranges5 getEMPTY() {
            return Ranges5.EMPTY;
        }
    }
}
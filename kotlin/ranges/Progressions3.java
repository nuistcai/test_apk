...
public class Progressions3 implements Iterable<Long>, KMarkers {
    ...
    public Progressions3(long start, long endInclusive, long step) {
        if (step == 0) {
    ...
    public boolean equals(Object other) {
        return (other instanceof Progressions3) && ((isEmpty() && ((Progressions3) other).isEmpty()) || (this.first == ((Progressions3) other).first && this.last == ((Progressions3) other).last && this.step == ((Progressions3) other).step));
    }
    ...
    /* renamed from: kotlin.ranges.LongProgression$Companion, reason: from kotlin metadata */
    public static final class Companion {
        ...
        public final Progressions3 fromClosedRange(long rangeStart, long rangeEnd, long step) {
            return new Progressions3(rangeStart, rangeEnd, step);
        }
    }
}
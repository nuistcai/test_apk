...
class Ranges7 extends RangesJVM2 {
    public static final <T extends Comparable<? super T>> Range<T> rangeTo(T rangeTo, T that) {
        ...
        return new Ranges4(rangeTo, that);
    }

    public static final Ranges3<Double> rangeTo(double $this$rangeTo, double that) {
        return new Ranges2($this$rangeTo, that);
    }
    ...
    private static final boolean contains(Iterable contains, Object element) {
        ...
        return element != null && ((Range) contains).contains((Comparable) element);
    }

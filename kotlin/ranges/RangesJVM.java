...
final class RangesJVM implements Ranges3<Float> {
    private final float _endInclusive;
    private final float _start;

    public RangesJVM(float start, float endInclusive) {
        this._start = start;
        this._endInclusive = endInclusive;
    }

    /* JADX WARN: Multi-variable type inference failed */
    @Override // kotlin.ranges.Ranges3, kotlin.ranges.Range
    ...
    public boolean equals(Object other) {
        return (other instanceof RangesJVM) && ((isEmpty() && ((RangesJVM) other).isEmpty()) || (this._start == ((RangesJVM) other)._start && this._endInclusive == ((RangesJVM) other)._endInclusive));
    }

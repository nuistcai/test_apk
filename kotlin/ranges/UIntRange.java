...
public final class UIntRange extends UIntRange2 implements Range<UInt> {
    ...
    public /* bridge */ /* synthetic */ boolean contains(Comparable comparable) {
        return m888containsWZ4Q5Ns(((UInt) comparable).getData());
    }

    @Override // kotlin.ranges.Range
    public UInt getStart() {
        return UInt.m90boximpl(getFirst());
    }

    @Override // kotlin.ranges.Range
    public UInt getEndInclusive() {
        return UInt.m90boximpl(getLast());
    }

    /* renamed from: contains-WZ4Q5Ns, reason: not valid java name */
    public boolean m888containsWZ4Q5Ns(int value) {
        return UnsignedUtils.uintCompare(getFirst(), value) <= 0 && UnsignedUtils.uintCompare(value, getLast()) <= 0;
    }

    @Override // kotlin.ranges.UIntRange2, kotlin.ranges.Range
    ...
    public String toString() {
        return UInt.m133toStringimpl(getFirst()) + ".." + UInt.m133toStringimpl(getLast());
    }

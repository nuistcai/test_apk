...
public final class CoroutineContextImpl2 implements CoroutineContext, Serializable {
    private final CoroutineContext.Element element;
    private final CoroutineContext left;

    public CoroutineContextImpl2(CoroutineContext left, CoroutineContext.Element element) {
    ...
    public <E extends CoroutineContext.Element> E get(CoroutineContext.Key<E> key) {
        ...
        while (true) {
            CoroutineContextImpl2 coroutineContextImpl2 = (CoroutineContextImpl2) coroutineContext;
            E e = (E) coroutineContextImpl2.element.get(key);
            if (e != null) {
                return e;
            }
            CoroutineContext coroutineContext2 = coroutineContextImpl2.left;
            if (coroutineContext2 instanceof CoroutineContextImpl2) {
    ...
    public CoroutineContext minusKey(CoroutineContext.Key<?> key) {
        ...
        return newLeft == this.left ? this : newLeft == CoroutineContextImpl3.INSTANCE ? this.element : new CoroutineContextImpl2(newLeft, this.element);
    }

    private final int size() {
        CoroutineContextImpl2 cur = this;
        int size = 2;
        while (true) {
            CoroutineContext coroutineContext = cur.left;
            if (!(coroutineContext instanceof CoroutineContextImpl2)) {
                coroutineContext = null;
            }
            CoroutineContextImpl2 coroutineContextImpl2 = (CoroutineContextImpl2) coroutineContext;
            if (coroutineContextImpl2 == null) {
                return size;
            }
            cur = coroutineContextImpl2;
            size++;
        }
    }
    ...
    private final boolean containsAll(CoroutineContextImpl2 context) {
        CoroutineContextImpl2 cur = context;
        while (contains(cur.element)) {
            CoroutineContext next = cur.left;
            if (next instanceof CoroutineContextImpl2) {
                cur = (CoroutineContextImpl2) next;
            } else {
                if (next != null) {
    ...
    public boolean equals(Object other) {
        return this == other || ((other instanceof CoroutineContextImpl2) && ((CoroutineContextImpl2) other).size() == size() && ((CoroutineContextImpl2) other).containsAll(this));
    }
    ...
    private static final class Serialized implements Serializable {
        ...
        private final Object readResolve() {
            ...
            Object initial$iv = CoroutineContextImpl3.INSTANCE;

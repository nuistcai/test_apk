...
/* renamed from: kotlin.coroutines.experimental.SequenceBuilderIterator, reason: use source file name */
/* loaded from: classes.dex */
final class SequenceBuilder2<T> extends SequenceBuilder<T> implements Iterator<T>, Coroutines<Unit>, KMarkers {
    ...
    public final void setNextStep(Coroutines<? super Unit> coroutines) {
    ...
    public Object yield(T t, Coroutines<? super Unit> coroutines) {
        this.nextValue = t;
        this.state = 3;
    ...
    @Override // kotlin.coroutines.experimental.SequenceBuilder
    public Object yieldAll(Iterator<? extends T> it, Coroutines<? super Unit> coroutines) {
        if (!it.hasNext()) {

...
/* renamed from: kotlin.coroutines.experimental.intrinsics.IntrinsicsKt__IntrinsicsKt, reason: use source file name */
/* loaded from: classes.dex */
class Intrinsics2 extends IntrinsicsKt__IntrinsicsJvmKt {
    private static final <T> Object suspendCoroutineOrReturn(Function1<? super Coroutines<? super T>, ? extends Object> function1, Coroutines<? super T> coroutines) {
        InlineMarker.mark(0);
        Object objInvoke = function1.invoke(CoroutineIntrinsics.normalizeContinuation(coroutines));
        InlineMarker.mark(1);
        return objInvoke;
    }
    ...
    private static final <T> Coroutines<T> intercepted(Coroutines<? super T> coroutines) {

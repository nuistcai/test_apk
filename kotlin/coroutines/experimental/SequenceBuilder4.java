...
/* renamed from: kotlin.coroutines.experimental.SequenceBuilderKt__SequenceBuilderKt, reason: use source file name */
/* loaded from: classes.dex */
class SequenceBuilder4 {
    ...
    public static final <T> Sequence<T> buildSequence(final Function2<? super SequenceBuilder<? super T>, ? super Coroutines<? super Unit>, ? extends Object> builderAction) {
        ...
        return new Sequence<T>() { // from class: kotlin.coroutines.experimental.SequenceBuilderKt__SequenceBuilderKt$buildSequence$$inlined$Sequence$1
            ...
            public Iterator<T> iterator() {
                return SequenceBuilder3.buildIterator(builderAction);
            }
        };
    }

    public static final <T> Iterator<T> buildIterator(Function2<? super SequenceBuilder<? super T>, ? super Coroutines<? super Unit>, ? extends Object> builderAction) {
        Intrinsics.checkParameterIsNotNull(builderAction, "builderAction");
        SequenceBuilder2 iterator = new SequenceBuilder2();

...
public abstract class CoroutineImpl extends Lambda<Object> implements Coroutines<Object> {
    ...
    public CoroutineImpl(int arity, Coroutines<Object> coroutines) {
        super(arity);
    ...
    public Coroutines<Unit> create(Object value, Coroutines<?> completion) {
        Intrinsics.checkParameterIsNotNull(completion, "completion");

...
import kotlin.D8$$SyntheticClass4;
...
/* renamed from: kotlin.coroutines.experimental.SafeContinuation, reason: use source file name */
/* loaded from: classes.dex */
public final class SafeContinuationJvm2<T> implements Coroutines<T> {
    ...
    private static final AtomicReferenceFieldUpdater<SafeContinuationJvm2<?>, Object> RESULT = AtomicReferenceFieldUpdater.newUpdater(SafeContinuationJvm2.class, Object.class, "result");

    /* JADX WARN: Multi-variable type inference failed */
    public SafeContinuationJvm2(Coroutines<? super T> delegate, Object initialResult) {
    ...
    public SafeContinuationJvm2(Coroutines<? super T> delegate) {
    ...
    /* renamed from: kotlin.coroutines.experimental.SafeContinuation$Companion, reason: from kotlin metadata */
    ...
    /* renamed from: kotlin.coroutines.experimental.SafeContinuation$Fail */
    ...
    public void resume(T value) {
        while (true) {
            ...
            if (result == UNDECIDED) {
                if (D8$$SyntheticClass4.m(RESULT, this, UNDECIDED, value)) {
                    return;
                }
            } else {
                ...
                if (D8$$SyntheticClass4.m(RESULT, this, IntrinsicsKt.getCOROUTINE_SUSPENDED(), RESUMED)) {
    ...
    public void resumeWithException(Throwable exception) {
        ...
        while (true) {
            Object result = this.result;
            if (result == UNDECIDED) {
                if (D8$$SyntheticClass4.m(RESULT, this, UNDECIDED, new Fail(exception))) {
                    return;
                }
            } else {
                if (result != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
    ...
    public final Object getResult() throws Throwable {
        Object result = this.result;
        if (result == UNDECIDED) {
            if (D8$$SyntheticClass4.m(RESULT, this, UNDECIDED, IntrinsicsKt.getCOROUTINE_SUSPENDED())) {

...
public interface CoroutineContext {
    ...
    public static final class DefaultImpls {
        public static CoroutineContext plus(CoroutineContext $this, CoroutineContext context) {
            ...
            return context == CoroutineContextImpl6.INSTANCE ? $this : (CoroutineContext) context.fold($this, new Function2<CoroutineContext, Element, CoroutineContext>() { // from class: kotlin.coroutines.experimental.CoroutineContext.plus.1
                ...
                public final CoroutineContext invoke(CoroutineContext acc, Element element) {
                    ...
                    if (removed == CoroutineContextImpl6.INSTANCE) {
                        return element;
                    }
                    ContinuationInterceptor interceptor = (ContinuationInterceptor) removed.get(ContinuationInterceptor.INSTANCE);
                    if (interceptor == null) {
                        left = new CoroutineContextImpl5(removed, element);
                    } else {
                        CoroutineContext left2 = removed.minusKey(ContinuationInterceptor.INSTANCE);
                        left = left2 == CoroutineContextImpl6.INSTANCE ? new CoroutineContextImpl5(element, interceptor) : new CoroutineContextImpl5(new CoroutineContextImpl5(left2, element), interceptor);
                    }
                    return left;
                }
            });
    ...
    public interface Element extends CoroutineContext {
        ...
        public static final class DefaultImpls {
            ...
            public static CoroutineContext minusKey(Element $this, Key<?> key) {
                Intrinsics.checkParameterIsNotNull(key, "key");
                return $this.getKey() == key ? CoroutineContextImpl6.INSTANCE : $this;
            }
        }
    }
}
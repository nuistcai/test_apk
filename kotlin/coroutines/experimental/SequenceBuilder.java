...
public abstract class SequenceBuilder<T> {
    public abstract Object yield(T t, Coroutines<? super Unit> coroutines);

    public abstract Object yieldAll(Iterator<? extends T> it, Coroutines<? super Unit> coroutines);

    public final Object yieldAll(Iterable<? extends T> iterable, Coroutines<? super Unit> coroutines) {
        return ((iterable instanceof Collection) && ((Collection) iterable).isEmpty()) ? Unit.INSTANCE : yieldAll(iterable.iterator(), coroutines);
    }

    public final Object yieldAll(Sequence<? extends T> sequence, Coroutines<? super Unit> coroutines) {
        return yieldAll(sequence.iterator(), coroutines);
    }
}
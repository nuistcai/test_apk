...
/* renamed from: kotlin.coroutines.experimental.CombinedContext, reason: use source file name */
/* loaded from: classes.dex */
public final class CoroutineContextImpl5 implements CoroutineContext {
    private final CoroutineContext.Element element;
    private final CoroutineContext left;

    public CoroutineContextImpl5(CoroutineContext left, CoroutineContext.Element element) {
    ...
    public <E extends CoroutineContext.Element> E get(CoroutineContext.Key<E> key) {
        ...
        while (true) {
            CoroutineContextImpl5 coroutineContextImpl5 = (CoroutineContextImpl5) coroutineContext;
            E e = (E) coroutineContextImpl5.element.get(key);
            if (e != null) {
                return e;
            }
            CoroutineContext coroutineContext2 = coroutineContextImpl5.left;
            if (coroutineContext2 instanceof CoroutineContextImpl5) {
    ...
    public CoroutineContext minusKey(CoroutineContext.Key<?> key) {
        ...
        return newLeft == this.left ? this : newLeft == CoroutineContextImpl6.INSTANCE ? this.element : new CoroutineContextImpl5(newLeft, this.element);
    }

    private final int size() {
        if (this.left instanceof CoroutineContextImpl5) {
            return ((CoroutineContextImpl5) this.left).size() + 1;
        }
        return 2;
    }
    ...
    private final boolean containsAll(CoroutineContextImpl5 context) {
        CoroutineContextImpl5 cur = context;
        while (contains(cur.element)) {
            CoroutineContext next = cur.left;
            if (next instanceof CoroutineContextImpl5) {
                cur = (CoroutineContextImpl5) next;
            } else {
                if (next != null) {
    ...
    public boolean equals(Object other) {
        return this == other || ((other instanceof CoroutineContextImpl5) && ((CoroutineContextImpl5) other).size() == size() && ((CoroutineContextImpl5) other).containsAll(this));
    }

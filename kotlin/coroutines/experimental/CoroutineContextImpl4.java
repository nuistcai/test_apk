...
/* renamed from: kotlin.coroutines.experimental.AbstractCoroutineContextElement, reason: use source file name */
/* loaded from: classes.dex */
public abstract class CoroutineContextImpl4 implements CoroutineContext.Element {
    private final CoroutineContext.Key<?> key;

    public CoroutineContextImpl4(CoroutineContext.Key<?> key) {

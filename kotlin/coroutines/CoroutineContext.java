...
public interface CoroutineContext {
    ...
    public static final class DefaultImpls {
        public static CoroutineContext plus(CoroutineContext $this, CoroutineContext context) {
            ...
            return context == CoroutineContextImpl3.INSTANCE ? $this : (CoroutineContext) context.fold($this, new Function2<CoroutineContext, Element, CoroutineContext>() { // from class: kotlin.coroutines.CoroutineContext.plus.1
                ...
                public final CoroutineContext invoke(CoroutineContext acc, Element element) {
                    ...
                    if (removed == CoroutineContextImpl3.INSTANCE) {
                        return element;
                    }
                    ContinuationInterceptor interceptor = (ContinuationInterceptor) removed.get(ContinuationInterceptor.INSTANCE);
                    if (interceptor == null) {
                        left = new CoroutineContextImpl2(removed, element);
                    } else {
                        CoroutineContext left2 = removed.minusKey(ContinuationInterceptor.INSTANCE);
                        left = left2 == CoroutineContextImpl3.INSTANCE ? new CoroutineContextImpl2(element, interceptor) : new CoroutineContextImpl2(new CoroutineContextImpl2(left2, element), interceptor);
                    }
                    return left;
                }
            });
    ...
    public interface Element extends CoroutineContext {
        ...
        public static final class DefaultImpls {
            ...
            public static CoroutineContext minusKey(Element $this, Key<?> key) {
                Intrinsics.checkParameterIsNotNull(key, "key");
                return Intrinsics.areEqual($this.getKey(), key) ? CoroutineContextImpl3.INSTANCE : $this;
            }
        }
    }
}
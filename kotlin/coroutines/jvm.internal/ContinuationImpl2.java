...
public abstract class ContinuationImpl2 implements Continuation<Object>, CoroutineStackFrame, Serializable {
    ...
    public final void resumeWith(Object result) {
        ...
        Object outcome;
        ContinuationImpl2 continuationImpl2 = this;
        Object param = result;
        while (true) {
            DebugProbes.probeCoroutineResumed(continuationImpl2);
            ContinuationImpl2 $this$with = continuationImpl2;
            ...
            try {
                ...
                objM11constructorimpl = Result.m11constructorimpl(Result2.createFailure(exception));
            }
            if (outcome == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                return;
            }
            Result.Companion companion2 = Result.INSTANCE;
            objM11constructorimpl = Result.m11constructorimpl(outcome);
            Object outcome2 = objM11constructorimpl;
            $this$with.releaseIntercepted();
            if (completion instanceof ContinuationImpl2) {
                continuationImpl2 = (ContinuationImpl2) completion;
                param = outcome2;
            } else {

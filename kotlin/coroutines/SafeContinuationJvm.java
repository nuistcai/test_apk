...
import kotlin.coroutines.intrinsics.Intrinsics3;
...
public final class SafeContinuationJvm<T> implements Continuation<T>, CoroutineStackFrame {
    ...
    public SafeContinuationJvm(Continuation<? super T> delegate) {
        this(delegate, Intrinsics3.UNDECIDED);
        Intrinsics.checkParameterIsNotNull(delegate, "delegate");
    }
    ...
    public void resumeWith(Object result) {
        while (true) {
            ...
            if (cur == Intrinsics3.UNDECIDED) {
                if (D8$$SyntheticClass4.m(RESULT, this, Intrinsics3.UNDECIDED, result)) {
                    return;
                }
            } else {
                ...
                if (D8$$SyntheticClass4.m(RESULT, this, IntrinsicsKt.getCOROUTINE_SUSPENDED(), Intrinsics3.RESUMED)) {
    ...
    public final Object getOrThrow() throws Throwable {
        ...
        if (result == Intrinsics3.UNDECIDED) {
            if (D8$$SyntheticClass4.m(RESULT, this, Intrinsics3.UNDECIDED, IntrinsicsKt.getCOROUTINE_SUSPENDED())) {
                return IntrinsicsKt.getCOROUTINE_SUSPENDED();
            }
            result = this.result;
        }
        if (result == Intrinsics3.RESUMED) {
            return IntrinsicsKt.getCOROUTINE_SUSPENDED();
        }

...
public class SqlDateDeserializer extends AbstractDateDeserializer implements ObjectDeserializer {
    ...
    protected <T> T cast(DefaultJSONParser defaultJSONParser, Type type, Object obj, Object obj2) throws NumberFormatException {
        long timeInMillis;
        if (this.timestamp) {
    ...
    protected <T> T castTimestamp(DefaultJSONParser defaultJSONParser, Type type, Object obj, Object obj2) throws NumberFormatException {
        long timeInMillis;
        if (obj2 == null) {
            return null;
        }

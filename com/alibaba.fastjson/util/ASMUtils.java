...
public class ASMUtils {
    ...
    public static String type(Class<?> parameterType) {
        ...
        String clsName2 = getPrimitiveLetter(parameterType);
        return clsName2;
    }
    ...
    public static String[] lookupParameterNames(AccessibleObject methodOrCtor) throws IOException {
        Class<?>[] types;
        ...
        if (methodOrCtor instanceof Method) {
            ...
            Annotation[][] parameterAnnotations2 = TypeUtils.getParameterAnnotations(method);
        ...
        InputStream is = classLoader2.getResourceAsStream(resourceName);
        try {
            if (is == null) {
                return new String[0];
            }

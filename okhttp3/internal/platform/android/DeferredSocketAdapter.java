    ...
    private final synchronized SocketAdapter getDelegate(SSLSocket actualSSLSocketClass) {
        if (!this.initialized) {
            try {
                ...
                while (!Intrinsics.areEqual(possibleClass.getName(), this.socketPackage + ".OpenSSLSocketImpl")) {
                ...
                Platform.INSTANCE.get().log(5, "Failed to initialize DeferredSocketAdapter " + this.socketPackage, e);
            }

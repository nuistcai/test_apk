...
public final class OkHostnameVerifier implements HostnameVerifier {
    ...
    private final boolean verifyHostname(String hostname, String pattern) {
        ...
        if (!StringsKt.startsWith$default(pattern3, CertificatePinner.WILDCARD, false, 2, (Object) null) || StringsKt.indexOf$default((CharSequence) pattern3, '*', 1, false, 4, (Object) null) != -1 || hostname2.length() < pattern3.length() || Intrinsics.areEqual(CertificatePinner.WILDCARD, pattern3)) {
            return false;
        }
        if (pattern3 == null) {
            throw new TypeCastException("null cannot be cast to non-null type java.lang.String");

...
public final class CipherSuite {
    ...
    public static final CipherSuite TLS_DHE_RSA_WITH_AES_128_GCM_SHA256 = INSTANCE.init("TLS_DHE_RSA_WITH_AES_128_GCM_SHA256", Opcodes.IFLE);
    public static final CipherSuite TLS_DHE_RSA_WITH_AES_256_GCM_SHA384 = INSTANCE.init("TLS_DHE_RSA_WITH_AES_256_GCM_SHA384", Opcodes.IF_ICMPEQ);
    public static final CipherSuite TLS_DHE_DSS_WITH_AES_128_GCM_SHA256 = INSTANCE.init("TLS_DHE_DSS_WITH_AES_128_GCM_SHA256", Opcodes.IF_ICMPGE);
    public static final CipherSuite TLS_DHE_DSS_WITH_AES_256_GCM_SHA384 = INSTANCE.init("TLS_DHE_DSS_WITH_AES_256_GCM_SHA384", Opcodes.IF_ICMPGT);
    public static final CipherSuite TLS_DH_anon_WITH_AES_128_GCM_SHA256 = INSTANCE.init("TLS_DH_anon_WITH_AES_128_GCM_SHA256", Opcodes.IF_ACMPNE);
    public static final CipherSuite TLS_DH_anon_WITH_AES_256_GCM_SHA384 = INSTANCE.init("TLS_DH_anon_WITH_AES_256_GCM_SHA384", Opcodes.GOTO);

...
public final class HttpUrl {
    ...
    public final URL m1051deprecated_url() {
        return url();
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to toUri()", replaceWith = @ReplaceWith(expression = "toUri()", imports = {}))
    /* renamed from: -deprecated_uri, reason: not valid java name */
    public final URI m1050deprecated_uri() {
        return uri();
    }
    ...
    public final String m1039deprecated_encodedUsername() {
    ...
    public final String m1035deprecated_encodedPassword() {
    ...
    public final int m1044deprecated_pathSize() {
        return pathSize();
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "encodedPath", imports = {}))
    /* renamed from: -deprecated_encodedPath, reason: not valid java name */
    public final String m1036deprecated_encodedPath() {
        return encodedPath();
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "encodedPathSegments", imports = {}))
    /* renamed from: -deprecated_encodedPathSegments, reason: not valid java name */
    public final List<String> m1037deprecated_encodedPathSegments() {
        return encodedPathSegments();
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "pathSegments", imports = {}))
    /* renamed from: -deprecated_pathSegments, reason: not valid java name */
    public final List<String> m1043deprecated_pathSegments() {
        return this.pathSegments;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "encodedQuery", imports = {}))
    /* renamed from: -deprecated_encodedQuery, reason: not valid java name */
    public final String m1038deprecated_encodedQuery() {
        return encodedQuery();
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "query", imports = {}))
    /* renamed from: -deprecated_query, reason: not valid java name */
    public final String m1046deprecated_query() {
        return query();
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "querySize", imports = {}))
    /* renamed from: -deprecated_querySize, reason: not valid java name */
    public final int m1048deprecated_querySize() {
        return querySize();
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "queryParameterNames", imports = {}))
    /* renamed from: -deprecated_queryParameterNames, reason: not valid java name */
    public final Set<String> m1047deprecated_queryParameterNames() {
        return queryParameterNames();
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "encodedFragment", imports = {}))
    /* renamed from: -deprecated_encodedFragment, reason: not valid java name */
    public final String m1034deprecated_encodedFragment() {
    ...
    public static final class Builder {
        ...
        public final Builder fragment(String fragment) {
            Builder $this$apply = this;
            $this$apply.encodedFragment = fragment != null ? Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, fragment, 0, 0, "", false, false, false, true, null, Opcodes.NEW, null) : null;
            return this;
        }
        ...
        public final Builder reencodeForUri$okhttp() {
            ...
            String strCanonicalize$okhttp$default2 = null;
            if (encodedQueryNamesAndValues != null) {
                int size2 = encodedQueryNamesAndValues.size();
                for (int i2 = 0; i2 < size2; i2++) {
                    String str = encodedQueryNamesAndValues.get(i2);
                    if (str == null) {
                        strCanonicalize$okhttp$default = null;
                    } else {
                        strCanonicalize$okhttp$default = Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, str, 0, 0, HttpUrl.QUERY_COMPONENT_ENCODE_SET_URI, true, true, true, false, null, 195, null);
                    }
                    encodedQueryNamesAndValues.set(i2, strCanonicalize$okhttp$default);
                }
            }
            String str2 = $this$apply.encodedFragment;
            if (str2 != null) {
                strCanonicalize$okhttp$default2 = Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, str2, 0, 0, HttpUrl.FRAGMENT_ENCODE_SET_URI, true, true, false, true, null, Opcodes.IF_ICMPGT, null);
            }
            $this$apply.encodedFragment = strCanonicalize$okhttp$default2;
            return this;
        }
        ...
        */
        public String toString() {
            ...
            HttpUrl.INSTANCE.toPathString$okhttp(this.encodedPathSegments, $this$buildString);
        ...
        public final Builder parse$okhttp(HttpUrl base, String input) {
            ...
            if (pos < limit6 && input.charAt(pos) == '#') {
                this.encodedFragment = Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, input, pos + 1, limit6, "", true, false, false, true, null, Opcodes.ARETURN, null);
            }
            return this;
        }
    ...
    public static final class Companion {
        ...
        */
        ...
        public final HttpUrl m1053deprecated_get(String url) {
            Intrinsics.checkParameterIsNotNull(url, "url");
            return get(url);
        }
        ...
        public final HttpUrl m1056deprecated_parse(String url) {
            Intrinsics.checkParameterIsNotNull(url, "url");
            return parse(url);
        }
        ...
        @Deprecated(level = DeprecationLevel.ERROR, message = "moved to extension function", replaceWith = @ReplaceWith(expression = "url.toHttpUrlOrNull()", imports = {"okhttp3.HttpUrl.Companion.toHttpUrlOrNull"}))
        /* renamed from: -deprecated_get, reason: not valid java name */
        public final HttpUrl m1055deprecated_get(URL url) {
            Intrinsics.checkParameterIsNotNull(url, "url");
            return get(url);
        }
        ...
        /* renamed from: -deprecated_get, reason: not valid java name */
        public final HttpUrl m1054deprecated_get(URI uri) {

...
/* renamed from: okhttp3.Handshake$Companion$handshake$1 */
/* loaded from: classes.dex */
final class Handshake3 extends Lambda implements Function0<List<? extends Certificate>> {
    final /* synthetic */ List $peerCertificatesCopy;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    Handshake3(List list) {
        super(0);

...
public final class CacheControl {
    ...
    public static final class Builder {
        ...
        private final int clampToInt(long $this$clampToInt) {
            if ($this$clampToInt > IntCompanionObject.MAX_VALUE) {
                        ...
                        if (value.charAt(pos2) == ',' || value.charAt(pos2) == ';') {
                            ...
                            if (pos3 < value.length() && value.charAt(pos3) == '\"') {
                                ...
                                if (value != null) {
                                    ...
                                    Intrinsics.checkExpressionValueIsNotNull(parameter, "(this as java.lang.Strin…ing(startIndex, endIndex)");
                                    pos = pos5 + 1;
                                    mustRevalidate = mustRevalidate2;
                                } else {
                                    throw new TypeCastException("null cannot be cast to non-null type java.lang.String");
                            ...
                            if (!StringsKt.equals("no-cache", directive, true)) {
                                ...
                                maxStaleSeconds = Util.toNonNegativeInt(parameter, IntCompanionObject.MAX_VALUE);
                                noCache = noCache2;
                                noStore = noStore2;
                                maxAgeSeconds = maxAgeSeconds2;
                                sMaxAgeSeconds = sMaxAgeSeconds2;

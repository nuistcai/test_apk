...
public class NotificationCompat {
    ...
    public static abstract class Style {
        ...
        */
        ...
        private Bitmap createColoredBitmap(int iconId, int color, int size) throws Resources.NotFoundException {
        ...
        private Bitmap createIconWithBackground(int iconId, int size, int iconSize, int color) throws Resources.NotFoundException {

...
public abstract class VersionedParcel {
    ...
    public <T> void writeSet(Set<T> val, int fieldId) throws IllegalAccessException, IOException, IllegalArgumentException, InvocationTargetException {
        writeCollection(val, fieldId);
    }

    public <T> void writeList(List<T> val, int fieldId) throws IllegalAccessException, IOException, IllegalArgumentException, InvocationTargetException {
        writeCollection(val, fieldId);
    }
    ...
    public <T> void writeArray(T[] val, int fieldId) throws IllegalAccessException, IOException, IllegalArgumentException, InvocationTargetException {
        setOutputField(fieldId);
        writeArray(val);
    }
    ...
    public void writeVersionedParcelable(VersionedParcelable p, int fieldId) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        setOutputField(fieldId);
